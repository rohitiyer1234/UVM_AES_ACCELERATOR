...
module AES_Decrypt_Pipe #(
    ...
    // BUG-D1 fix: decrypt pipeline is exactly NUM_ROUNDS deep (10 stages)
    localparam int PIPE_DEPTH = NUM_ROUNDS;
    ...
    logic stall;
    assign stall    = valid[PIPE_DEPTH-1] && !out_ready;  // BUG-D1 fix
