...
REM
REM Generated by Vivado on Sun Apr 19 16:39:42 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_key_system_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_key_system_vlog.prj -log xvlog.log
